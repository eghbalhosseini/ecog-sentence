...
cfg.headshape = '/Users/eghbalhosseiniasl1/MyData/ecog-sentence/subjects_raw/AMC037/IMAGING/surf/lh.pial';

cfg.fshome = '/Applications/freesurfer';
if ~exist(['/Users/eghbalhosseiniasl1/MyData/ecog-sentence/subjects_raw/AMC037/IMAGING/','AMC037_hull_lh.mat'])
AMC037_hull_lh = ft_prepare_mesh(cfg);
save(['/Users/eghbalhosseiniasl1/MyData/ecog-sentence/subjects_raw/AMC037/IMAGING/','AMC037_hull_lh.mat'], 'AMC037_hull_lh');
else 
    load(['/Users/eghbalhosseiniasl1/MyData/ecog-sentence/subjects_raw/AMC037/IMAGING/','AMC037_hull_lh.mat'], 'AMC037_hull_lh');
end 

%% 
pial = load('/Users/eghbalhosseiniasl1/MyData/ecog-sentence/subjects_raw/AMC037/IMAGING/alignment/brain_model_raw.mat');
pial.pos=pial.cortex.vert;
pial.tri=pial.cortex.tri;
%
sub_brain=load(['/Users/eghbalhosseiniasl1/MyData/ecog-sentence/subjects_raw/AMC037/IMAGING/MATLAB/','AMC037_brain.mat']);
sub_crtx.pos=sub_brain.cortex.vert;
sub_crtx.tri=sub_brain.cortex.tri;
%
alignment_mat=load(['/Users/eghbalhosseiniasl1/MyData/ecog-sentence/subjects_raw/AMC037/IMAGING/alignment/alignment/','rigid_iter_200_transform.mat']);
...
cfg.elec = elec_acpc_fr;
cfg.method = 'headshape';
cfg.headshape = '/Users/eghbalhosseiniasl1/MyData/ecog-sentence/subjects_raw/AMC037/IMAGING/segmentation/surf/lh.pial';
cfg.warp = 'fsaverage';
cfg.fshome = '/Applications/freesurfer';
...
save(['/Users/eghbalhosseiniasl1/MyData/ecog-sentence/subjects_raw/AMC037/IMAGING/','AMC037_elec_fsavg.mat'], 'elec_fsavg_frs');


%% 
% fsmri_acpc = ft_read_mri('/Users/eghbalhosseiniasl1/MyData/ecog-sentence/subjects_raw/AMC037/IMAGING/segmentation/mri/brain.mgz'); % on Windows, use 'SubjectUCI29_MR_acpc.nii'
